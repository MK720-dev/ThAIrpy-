...
def visualize_and_create_pose_sequence(gif_path, keypoints_list, output_gif_path, default_fps=10):
    ...
    # Get consistent frame shape from the first frame
    first_frame = gif.get_next_data()
    ...
    for frame_index, (frame, keypoints) in enumerate(zip(gif, keypoints_list)):
        frame = cv2.resize(frame, (frame_width, frame_height))  # Ensure consistent size
...
input_gif_path = r"C:\Users\kchao\Downloads\barbellsquat-1491916408.gif"  # Replace with the path to your input GIF
output_gif_path = r"C:\Users\kchao\Downloads\output_gif_with_keypoints1.gif"  # Path to save the new GIF with keypoints overlay
